...
import (
	...
	"github.com/xrlnewman/hireflow-admin/server/internal/platform/database"
	"github.com/xrlnewman/hireflow-admin/server/internal/platform/store"
	"github.com/xrlnewman/hireflow-admin/server/internal/transport/httpapi"
)
...
func main() {
	...
	defer stop()
	go func() {
		slog.Info("HireFlow API 已启动", "addr", cfg.Addr)
